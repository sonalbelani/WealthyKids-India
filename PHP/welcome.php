...
.button5:hover {
  ...
  <div>
  <button class="button button1" onclick="location.href = './SSY.php';">Details</button>
  <table>
  <tr>
...
font-size:100%;">Maturity Period<br><b> 21 years</b></br> </p>  </td>
  ...
  <div><button class="button button2" onclick="location.href = './PPY.php';">Details</button>
    <table>
    <tr>
  ...
  <div><button class="button button3" onclick="location.href = './NSC.php';">Details</button>
    <table>
    <tr>
